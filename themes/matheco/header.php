...
<head> 
  ...
  <symbol id="pro-thumb-lft-arrow" width="21" height="21" viewBox="0 0 21 21" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M5.20376 20.1332C4.81626 19.7679 4.80183 19.1568 5.16616 18.7713L13.2136 10.2766L5.1662 1.78288C4.80088 1.39732 4.8163 0.787183 5.2038 0.420917C5.5903 0.0546509 6.20044 0.0710172 6.56671 0.457563L15.2416 9.61441C15.4171 9.79946 15.5057 10.0385 15.5057 10.2766C15.5057 10.5146 15.4171 10.7546 15.2416 10.9397L6.56671 20.0966C6.2004 20.4831 5.5903 20.4995 5.20376 20.1332Z" fill="#707C88"/>
    </g>
    <defs>
    <clipPath id="clip0">
